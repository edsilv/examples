...
<<<<<<< HEAD
document.write('<script type="text/javascript" id="embedUV" src="/build/uv-1.0.47/js/embed.js"><\/script>');
=======
document.write('<script type="text/javascript" id="embedUV" src="/build/uv-1.0.48/js/embed.js"><\/script>');
>>>>>>> master
